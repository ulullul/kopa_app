...
const inputBorderColor = const Color(0x4DABB4BD);

const colorPrimaryText = const Color(0xffffffff);
const colorWhiteText = const Color(0xffF8F8F8);
const colorBlackText = const Color(0xff000000);
const hintStyleTextField = const Color(0xff808080);
